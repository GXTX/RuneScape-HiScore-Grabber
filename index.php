 ...
 *  Last update: 9/8/2012 3:55PM -5GMT (New skills?)
 *
 *
...
class rs{
	...
	private function compare($new, $old){
		...
		foreach ($new as $new_fe){
			if($i != 40){ //only 39 skills, but the page returns an /n
	...
	public function ready_out($old, $new){
		...
		$minigames = array_slice($data, 26, 14, true);
		$i = 0;
